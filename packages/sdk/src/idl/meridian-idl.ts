// AUTO-GENERATED from meridian.json by scripts/gen-idl-module.mjs — do not edit by hand.
...
const IDL = {
  ...
  instructions: [
    {
      ...
      discriminator: [226, 190, 94, 4, 5, 106, 15, 120],
      accounts: [
        {
          name: "admin",
          writable: true,
        ...
        {
          name: "usdc_mint",
          docs: ["The USDC collateral mint (must match Config.usdc_mint)."],
        },
        {
          name: "market",
          writable: true,
    ...
    },
    {
      ...
      discriminator: [138, 218, 221, 118, 96, 220, 75, 11],
      accounts: [
        {
          name: "admin",
          writable: true,
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: "const",
                value: [117, 115, 100, 99, 95, 101, 115, 99, 114, 111, 119],
              },
              {
                kind: "account",
                path: "market",
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: "const",
                value: [121, 101, 115, 95, 101, 115, 99, 114, 111, 119],
              },
              {
                kind: "account",
                path: "market",
    ...
    },
    {
      ...
      discriminator: [233, 31, 8, 169, 183, 56, 77, 99],
      accounts: [
        {
          name: "payer",
          writable: true,
    ...
    },
    {
      ...
      discriminator: [225, 19, 88, 90, 233, 246, 140, 84],
      accounts: [
        {
          name: "payer",
          writable: true,
    ...
    },
    {
      ...
      docs: ["One-time global setup. Creates the singleton `Config` PDA."],
    ...
    },
    {
      ...
      accounts: [
        {
          name: "cranker",
          docs: ["Anyone may crank. Pays no funds; only triggers settlement."],
          signer: true,
        },
        {
          name: "config",
    ...
    {
      name: "mint_pair",
      docs: ["Deposit $1.00 USDC, receive 1 Yes + 1 No token. (F-02)"],
      discriminator: [19, 149, 94, 110, 181, 186, 33, 107],
      accounts: [
        {
          name: "user",
          writable: true,
        ...
        {
          name: "usdc_mint",
          docs: ["The USDC mint (must match the vault's mint)."],
        },
        {
          name: "user_usdc",
          writable: true,
  ...
  events: [
    ...
    },
    {
      ...
      discriminator: [25, 152, 242, 238, 21, 34, 210, 174],
    },
    {
      name: "OrderCancelled",
    ...
    {
      name: "PairMinted",
      discriminator: [24, 66, 202, 249, 156, 196, 33, 51],
    },
    {
      name: "PauseSet",
      discriminator: [175, 57, 198, 136, 192, 66, 204, 73],
    },
    {
      name: "Redeemed",
    ...
    {
      name: "StrikeAdded",
      discriminator: [221, 90, 199, 207, 85, 235, 219, 228],
    },
  ],
  errors: [
    {
  ...
  types: [
    ...
    {
      name: "Config",
      docs: ["Global configuration singleton. PDA: `[CONFIG_SEED]`."],
      type: {
        kind: "struct",
        fields: [
          {
            name: "admin",
            docs: ["Authority allowed to create/settle/pause/override."],
            type: "pubkey",
          },
          {
            name: "usdc_mint",
            docs: ["The USDC mint used as collateral for every market."],
            type: "pubkey",
          },
          {
            name: "tickers",
            docs: ["Supported tickers and their oracle feed ids."],
            type: {
              array: [
                {
                  defined: {
          ...
          {
            name: "bump",
            docs: ["PDA bump for the config account."],
            type: "u8",
          },
        ],
      },
    ...
    {
      name: "ConfigInitialized",
      docs: ["Emitted once when the global config is created."],
      type: {
        kind: "struct",
        fields: [
          {
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: "no_mint",
            docs: ["SPL mint for No tokens."],
            type: "pubkey",
          },
          {
            name: "vault",
            docs: ["PDA-owned USDC collateral vault (token account)."],
            type: "pubkey",
          },
          {
            name: "order_book",
            docs: ["The order book account for this market."],
            type: "pubkey",
          },
          {
            name: "pairs_minted",
          ...
          {
            name: "outcome",
            docs: ["Settlement outcome (immutable once written)."],
            type: {
              defined: {
                name: "Outcome",
              },
          ...
          {
            name: "settled_at",
            docs: ["Timestamp settlement occurred."],
            type: {
              option: "i64",
            },
          },
          {
            name: "bump",
            docs: ["PDA bump for the market account."],
            type: "u8",
          },
          {
            name: "vault_bump",
            docs: ["PDA bump for the vault."],
            type: "u8",
          },
          {
            name: "mint_authority_bump",
            docs: ["PDA bump for the mint authority."],
            type: "u8",
          },
        ],
      },
    ...
    {
      name: "MarketCreated",
      docs: ["Emitted when a stock-strike-day market is provisioned (F-02)."],
      type: {
        kind: "struct",
        fields: [
          {
    ...
    {
      name: "MarketSettled",
      docs: ["Emitted once when a market is settled, via either path (F-04)."],
      type: {
        kind: "struct",
        fields: [
          {
          ...
          {
            name: "settlement_price",
            docs: ["Closing price written, in USDC base units (6 dp)."],
            type: "u64",
          },
          {
            name: "settled_at",
    ...
    {
      name: "MarketState",
      docs: ["Lifecycle state of a market."],
      type: {
        kind: "enum",
        variants: [
          {
    ...
    {
      name: "Order",
      docs: ["A single resting order on the Yes-vs-USDC book."],
      type: {
        kind: "struct",
        fields: [
          {
            name: "owner",
            docs: ["Owner of the order (and of any escrowed funds/tokens)."],
            type: "pubkey",
          },
          {
            name: "price",
            docs: ["Limit price in USDC-per-Yes, 6 dp, in `[0, PRICE_SCALE]`."],
            type: "u64",
          },
          {
            name: "size",
            docs: ["Remaining size in Yes-token base units."],
            type: "u64",
          },
          {
            name: "seq",
          ...
          {
            name: "side",
            docs: ["Which side this order is on."],
            type: {
              defined: {
                name: "OrderSide",
              },
          ...
          {
            name: "active",
            docs: ["Whether this slot is occupied (false = empty slot)."],
            type: "bool",
          },
        ],
      },
    },
    {
      ...
      type: {
        ...
        fields: [
          {
            name: "market",
            docs: ["Back-reference to the owning market."],
            type: "pubkey",
          },
          {
            name: "next_seq",
            docs: ["Monotonic counter handing out `Order::seq` values."],
            type: "u64",
          },
          {
            name: "bids",
          ...
          {
            name: "bump",
            docs: ["PDA bump for the order book account."],
            type: "u8",
          },
        ],
      },
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: "maker_seq",
            docs: ["The resting (maker) order's sequence number."],
            type: "u64",
          },
          {
            name: "maker",
          ...
          {
            name: "fill_size",
            docs: ["Yes-token base units exchanged in this fill."],
            type: "u64",
          },
          {
            name: "usdc_amount",
            docs: ["USDC base units exchanged in this fill."],
            type: "u64",
          },
        ],
      },
    ...
    {
      name: "OrderSide",
      docs: ["Which side of the (Yes-vs-USDC) order book an order rests on."],
      type: {
        kind: "enum",
        variants: [
          {
    ...
    {
      name: "Outcome",
      docs: ["Settlement outcome of a market."],
      type: {
        kind: "enum",
        variants: [
          {
    ...
    {
      name: "PairMinted",
      docs: ["Emitted when a user mints a Yes/No pair (F-02)."],
      type: {
        kind: "struct",
        fields: [
          {
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: "size",
            docs: ["Order size in Yes-token base units."],
            type: "u64",
          },
          {
            name: "is_market",
    ...
    {
      name: "RedeemSide",
      docs: ["Which outcome token the caller is redeeming."],
      type: {
        kind: "enum",
        variants: [
          {
    ...
    {
      name: "Redeemed",
      docs: ["Emitted when a user redeems settled tokens (F-02)."],
      type: {
        kind: "struct",
        fields: [
          {
